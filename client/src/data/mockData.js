...
export const getCampaignById = (id) => {
    ...
    const campaign = mockData.campaigns.find(c => c.id === numericId) || mockData.campaigns[0]; // Default to first if not found
    ...
    return {
        ...campaign,
        organizerAvatar: mockData.organizers[campaign.owner]?.avatar || mockData.organizers.default.avatar,
        organizerName: mockData.organizers[campaign.owner]?.name || campaign.organizerName,
        organizerLocation: mockData.organizers[campaign.owner]?.name ? campaign.organizerLocation : 'Global',
